...
// SEND EMAIL
// ============================================================
function tqs_send_inquiry_email($full_name,$email,$full_phone,$full_whatsapp,$travel_type,$from,$from_other,$destination,$dest_other,$travel_date,$return_dep,$return_arr,$mc_legs,$adults,$kids,$infants,$trip_type,$budget,$services,$quick_requests,$message) {
    $to=$to=get_option('tqs_admin_email',get_option('admin_email'));
    $total=$adults+$kids+$infants;
